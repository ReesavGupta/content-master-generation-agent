...
#         # Use LLM to suggest visual representations
#         try:
...
#         }
#     except Exception as e:
#         logging.error(f"Error in content planning or parsing: {outline.content}")
#         return {
#             "content_outline": {
...
#     initial_state = ContentMasterState(
#         user_request=user_request
#     )

#     # Stream the graph execution
#     try:
#         for output in content_master_graph.stream(initial_state):
...
#         final_result = content_master_graph.invoke(initial_state)
...
# # Optional: Add CLI argument support
# import argparse
...
# # Example CLI usage:
# # python content_master.py --request "Create a presentation on climate change"
